...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Answer.answer_idx'
        db.alter_column('datedge_answer', 'answer_idx', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Answer.answer_idx'
        db.alter_column('datedge_answer', 'answer_idx', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'datedge.answer': {
            ...
            'answer_idx': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
